                ...
                <tr key={c.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="py-4 px-5 text-right">
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-200 hover:border-brand-300 text-slate-700 hover:text-slate-900 font-semibold text-[11px] transition-colors"
                    >
                      View Profile
                    </button>
                  </td>
