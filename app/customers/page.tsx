...
export default function CustomersPage() {
      ...
      accessor: (row) => (
        <div className="flex items-center justify-end gap-1.5">
          <Link
            ...
            title="View Full Customer Profile Page"
            className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-brand-50 text-slate-600 dark:text-slate-300 hover:text-brand-600 transition-all flex items-center justify-center border border-slate-200 dark:border-slate-700"
          >
            <Eye className="w-3.5 h-3.5" />
          </Link>
          <button
            onClick={() => handleOpenEditDrawer(row)}
            title="Edit Customer Details (Slide-Over Drawer)"
            className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-brand-50 text-slate-600 hover:text-brand-600 transition-all cursor-pointer border border-slate-200 dark:border-slate-700"
          >
          ...
          <button
            ...
            className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-red-50 text-slate-600 hover:text-red-600 transition-all cursor-pointer border border-slate-200 dark:border-slate-700"
          >
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      {/* SINGLE PRIMARY TOP HEADER BANNER & ACTION BUTTON */}
      <div className="p-6 rounded-3xl bg-gradient-to-r from-brand-600 via-brand-700 to-purple-800 text-white shadow-lux flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-brand-200 text-xs font-bold uppercase tracking-wider mb-1">
            <Users className="w-4 h-4" /> Customer Directory Engine
          </div>
          <h1 className="text-2xl font-extrabold tracking-tight">Customer Directory & Accounts</h1>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-5 py-3 rounded-2xl bg-white text-brand-900 font-extrabold text-xs shadow-md hover:bg-brand-50 transition-all flex items-center gap-2 cursor-pointer shrink-0"
          >
